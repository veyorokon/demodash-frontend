...
function DemoDelivery(props) {
  return (
    <ImageFeature
      ...
      text={`For each store and/or influencer you choose to work with, you ship enough product for them to demo. Stores and influencers can then sell your product on their demodash store - the commission you set keeps them motivated!`}
    />
  );
}
